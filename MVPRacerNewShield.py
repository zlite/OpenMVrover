...
steering_center = 85  # set to your car's center point
...
thresholds = [(  0, 100,   31,  127,  -25,  127), # generic_red_thresholds
...
def steer(angle):
    ...
    angle = int(round(steering_direction*(angle+steering_center)*steering_gain))
